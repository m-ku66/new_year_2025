    ...
    return (
      <>
        <div
          ...
          className={`${
            language === "en" ? "hidden md:flex" : "hidden md:flex flex-col"
          }`}
        >
        ...
        <div className="md:hidden flex flex-col gap-4 items-center">
          <motion.div
            onClick={() => setToggleMobileDropDown(!toggleMobileDropDwon)}
            ...
            className="flex w-10 aspect-square justify-center items-center bg-black"
            key="mobile"
          >
            <svg
              width="24"
